function calculatorMaker(firstOperand = 0, secondOperand = 0) {
   ...
   this.checkOperand = function(firstOperand, secondOperand) {
      return (this.firstOperand instanceof Number || typeof this.firstOperand === 'number' && !isNaN(this.firstOperand)) && (this.secondOperand instanceof Number || typeof this.secondOperand === 'number' && !isNaN(this.secondOperand)) && (this.firstOperand !== 0 && this.secondOperand !== 0) ? true : false;
   }
 }
